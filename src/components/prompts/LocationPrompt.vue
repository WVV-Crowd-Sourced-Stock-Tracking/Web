<template>
  <div class="w-auto h-full mx-6 my-56 bg-white rounded-md shadow-md p-6 text-center text-gray-900">
      
    <div class="w-full font-bold mb-4">
      Wo bist du?
    </div>

    <img src="@/assets/icons/Pin.svg" alt="Pin" class="inline-block h-12 mb-4">
